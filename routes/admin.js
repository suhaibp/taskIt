...
router.put('/viewstatusadmin/:id', function(req, res) {
  ...
  // Date          : 06-04-2018
  // Last Modified : 06-04-2018, Yasir Poongadan
  // Desc          : get all estimated project
  router.post('/getEstimatedProject', function (req, res) {
    // console.log(req.body);
    ...
    if(req.body.selProj != 'All'){
      whereCond.project_id = req.body.selProj;
    }
    if(req.body.selCat != 'All'){
      prjWhereCond.category_id = req.body.selCat;
    }
    // console.log(whereCond);
    // console.log(prjWhereCond);
    Estimations.findAll({
      where: whereCond,
      include: [
        {
