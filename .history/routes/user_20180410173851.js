    ...
    Projects.findAll({
      ...
      if(resProjects.length<=0){
        ...
        resProjects.forEach(element => {
                temp.push({id:element.id,planned_end_date:element.planned_end_date,planned_start_date:element.planned_start_date,project_name:element.project_name,tbl_project_member_assocs:[]})
                element.forEach(ele => {
                temp.tbl_project_member_assocs.push({id:ele.id,project_id:ele.project_id})
            });
            });
        res.json(temp);
      }
