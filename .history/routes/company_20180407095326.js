 ...
 //  ---------------------------------Start-------------------------------------------
    ...
    router.post('/approveTask', function (req, res) {
        ...
        if (startDate >= endDate) {
            ...
            var zero = 0;
            var end_date_time = req.body.end_date.setHours(end_time.hour,end_time.minute,zero);
            var start_date_time = req.body.start_date.setHours(start_time.hour,start_time.minute,zero);
            console.log()
