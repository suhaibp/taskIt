...
export class CompanyTopbarComponent implements OnInit {
  ...
  refresh() {
    this.count = 0;
    console.log("this.assignHeadCount:"+this.assignHeadCount)
    console.log("this.approveEstimationCount:"+this.approveEstimationCount)
    console.log("this.approveProjectCount:"+this.approveProjectCount)
    console.log("this.planProjectCount:"+this.planProjectCount)
    console.log("this.resubmitEstimationCount:"+this.resubmitEstimationCount)
    console.log("this.newTaskreqBackCount:"+this.newTaskreqBackCount)
    console.log("this.newTaskreqCount:"+this.newTaskreqCount)
    console.log("this.userpendingdataCount:"+this.userpendingdataCount)
    console.log("this.adminnotifdataCount:"+this.adminnotifdataCount)
