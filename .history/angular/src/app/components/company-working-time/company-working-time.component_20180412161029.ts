...
//  ---------------------------------Start-------------------------------------------
  ...
  saveExtraBreak(){
      this.companyService.saveDayBreak(this.selectedDay, this.selectedWeek, this.xtime, this.ytime, this.xtrabreakTitle).subscribe(res2 =>{
      if(res2.status == 1){
      ...
      this.getDayDetails(this.selectedDay,this.selectedWeek);        
      }else{
        let snackBarRef = this.snackBar.open(res2.message, '', {
          duration: 2000
        });
  ...
  saveDayWorkTime(){
  //   this.companyService.getDayDetails(this.holiday, this.xtime, this.ytime).subscribe(res2 =>{
