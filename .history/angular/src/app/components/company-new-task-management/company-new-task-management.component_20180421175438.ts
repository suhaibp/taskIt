...
export class CompanyNewTaskManagementComponent implements OnInit {
  ...
  approve(){
    ...
    this.taskRequest.tbl_user_profile.start_time = this.lastDate;



    // let tbl_estimation_tasks = {tbl_estimation_tasks:[this.taskRequest]}
    // let module =[] 
    this.task = {modules:[this.taskRequest.assigned_person], teamMembers:[this.taskRequest.tbl_user_profile]}
