...
export class CompanyNewTaskManagementComponent implements OnInit {
  ...
  approve(){
    ...
    this.task = {modules:[this.taskRequest.tbl_project_module,tbl_estimation_tasks], teamMembers:this.taskRequest.tbl_user_profile}
    // let tbl_estimation_tasks = {tbl_estimation_tasks:[]}
    // this.task.modules.push(: this.taskRequest)
